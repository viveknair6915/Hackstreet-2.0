...
function ExploreCard({ id, imgUrl, title, index, active }) {
  return (
    ...
    >
      ...
      />
      {active !== id ? (
        <h3 className="mx-1 font-semibold sm:text-[26px] text-[18px] text-white absolute z-0 lg:bottom-20 lg:rotate-[-90deg] lg:origin-[0,0]">
          {title}
        </h3>
      ) : (
